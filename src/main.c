...
void initialize_images(t_game *game, t_map *map)
{
	...
	map->e = mlx_xpm_file_to_image(game->mlx, "graphics/e.xpm",
			&map->design->img_width, &map->design->img_height);
	map->design->player_img_up = mlx_xpm_file_to_image(game->mlx, "graphics/b.xpm",
			&map->design->img_width, &map->design->img_height);
	map->design->player_img_down = mlx_xpm_file_to_image(game->mlx, "graphics/f.xpm",
			&map->design->img_width, &map->design->img_height);
	map->design->player_img_left = mlx_xpm_file_to_image(game->mlx, "graphics/l.xpm",
			&map->design->img_width, &map->design->img_height);
	map->design->player_img_right = mlx_xpm_file_to_image(game->mlx, "graphics/r.xpm",
			&map->design->img_width, &map->design->img_height);
